...
private:
    ...
    struct FillImplNano {
        ...
        const FloatVector& GenPart_vertexX_;
        const FloatVector& GenPart_vertexY_;
        const FloatVector& GenPart_vertexZ_;
        ...
        FillImplNano(GenLepton& lepton, std::set<size_t>& processedParticles,
            ...
            GenPart_mass_(GenPart_mass), GenPart_vertexX_(GenPart_vertexX), GenPart_vertexY_(GenPart_vertexY), GenPart_vertexZ_(GenPart_vertexZ), GenPart_genPartIdxMother_(GenPart_genPartIdxMother),
        ...
        void FillDaughters(size_t part_idx, size_t mother_index, bool fill_recursively)
        {
            ...
            output_p.vertex = Point3D(GenPart_vertexX_.at(part_idx), GenPart_vertexY_.at(part_idx), GenPart_vertexZ_.at(part_idx));
